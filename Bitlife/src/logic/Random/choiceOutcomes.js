// src/logic/scenarios/choiceOutcomes.js
import { updatePlayerStat } from '../player/playerStats';
import { updateMorality } from '../player/moralityCalculator'; // Corrected path
import { handleRelationshipUpdate } from '../RelationshipLogic/relationshipIndex'; // Corrected path
import { emit, GAME_EVENTS } from '../game/gameEvents';
import { getRandomFloat } from '../Random/Randomness'; // Corrected path
import { AGE_GROUPS } from '../constants'; // Corrected path: lowercase 'c'

/**
 * This file contains functions to apply the consequences of player choices.
 * It interprets consequence objects and updates the game state accordingly.
 */
