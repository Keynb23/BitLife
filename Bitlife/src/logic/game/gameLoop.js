import { updatePlayerStat, isPlayerAlive, hasReachedEndOfLife } from '../player/playerStats';
import { AGE_UP_INCREMENT, DAILY_STAT_ADJUSTMENTS } from '../constants'; // Corrected path (lowercase 'c')
import { getRandomScenario } from '../scenarios/index';
import { applyChoiceConsequences } from '../scenarios/choiceOutcomes';
